...
trait ConfigDiscoveryTrait
{
    ...
    function getApplicationConfig()
    {
        ...
        $configFile = isset($this->projectDir) ? sprintf('%s/%s', $this->projectDir, $this->applicationConfigPath) : $this->applicationConfigPath;
        ...
        if (! is_array($this->applicationConfig)) {
            throw new RuntimeException('Invalid configuration returned from config/application.config.php;' . PHP_EOL . 'is this a zendframework application?' . PHP_EOL);
        }
